Run the python script to fetch all mile saver awards from United's APIs. Just give it the origination airport code (like IAD) and it'll do the rest. Enter when you first run the script.
...
** SHOUTOUT TO CZ FOR THE WEB UI IDEA!
